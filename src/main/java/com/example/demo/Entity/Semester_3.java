...
public class Semester_3 
{
    ...
    private String pap9n;
    private String pap9gr;
    private float pap9grp;
    
    private String pap10n;
    private String pap10gr;
    private float pap10grp;
	...
	public String getPap9n() {
		return pap9n;
	}
	public void setPap9n(String pap9n) {
		this.pap9n = pap9n;
	}
	public String getPap9gr() {
		return pap9gr;
	}
	public void setPap9gr(String pap9gr) {
		this.pap9gr = pap9gr;
	}
	public float getPap9grp() {
		return pap9grp;
	}
	public void setPap9grp(float pap9grp) {
		this.pap9grp = pap9grp;
	}
	public String getPap10n() {
		return pap10n;
	}
	public void setPap10n(String pap10n) {
		this.pap10n = pap10n;
	}
	public String getPap10gr() {
		return pap10gr;
	}
	public void setPap10gr(String pap10gr) {
		this.pap10gr = pap10gr;
	}
	public float getPap10grp() {
		return pap10grp;
	}
	public void setPap10grp(float pap10grp) {
		this.pap10grp = pap10grp;
	}
